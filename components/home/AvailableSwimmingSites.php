<?php
$get_swimming_sites = mysqli_query($mysqli, "SELECT s.*, COUNT(r.swimming_site_id) AS review_count FROM tbl_swimming_sites s LEFT JOIN tbl_swimming_site_reviews r ON s.id = r.swimming_site_id GROUP BY s.id ORDER BY s.number_of_tents DESC");
?>

<div class="component_wrapper">
    <h1><span style="color: var(--color-danger);">Available</span> Swimming Sites</h1>
